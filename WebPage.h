            ...
            <div class="for-move">
                ...
                <div class="for-move-b controlor">
                    <div class="controlor-c">
                        <div>
                            <div>
                                <label><button class="cc-btn" onmousedown="cmdSend(1,0.5,1);" ontouchstart="cmdSend(1,0.5,1);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);"><svg fill="none" version="1.1" width="23" height="23" viewBox="0 0 23 23"><g style="mix-blend-mode:passthrough"><path d="M0,2L0,18.1716C0,19.9534,2.15428,20.8457,3.41421,19.5858L19.5858,3.41421C20.8457,2.15428,19.9534,0,18.1716,0L2,0C0.895431,0,0,0.895431,0,2Z" fill="#D8D8D8" fill-opacity="0.20000000298023224"/></g></svg></button></label>
                                <label><button class="cc-btn" onmousedown="cmdSend(1,1,1);" ontouchstart="cmdSend(1,1,1);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);"><svg fill="none" version="1.1" width="26.87807685863504" height="15.435028109846826" viewBox="0 0 26.87807685863504 15.435028109846826"><g style="mix-blend-mode:passthrough" transform="matrix(0.9999999403953552,0,0,0.9999999403953552,0,0)"><path d="M12.0248,0.585787L0.589796,12.0208C-0.670133,13.2807,0.222199,15.435,2.00401,15.435L24.8741,15.435C26.6559,15.435,27.5482,13.2807,26.2883,12.0208L14.8533,0.585787C14.0722,-0.195262,12.8059,-0.195262,12.0248,0.585787Z" fill="#D8D8D8" fill-opacity="0.800000011920929"/></g></svg></button></label>
                                <label><button class="cc-btn" onmousedown="cmdSend(1,1,0.5);" ontouchstart="cmdSend(1,1,0.5);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);"><svg fill="none" version="1.1" width="23" height="23" viewBox="0 0 23 23"><g style="mix-blend-mode:passthrough" transform="matrix(0,1,-1,0,23,-23)"><path d="M23,2L23,18.1716C23,19.9534,25.15428,20.8457,26.41421,19.5858L42.5858,3.41421C43.8457,2.15428,42.9534,0,41.1716,0L25,0C23.895431,0,23,0.895431,23,2Z" fill="#D8D8D8" fill-opacity="0.20000000298023224"/></g></svg></button></label>
                            </div>
                            <div>
                                <label><button class="cc-btn" onmousedown="cmdSend(1,-1,1);" ontouchstart="cmdSend(1,-1,1);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);"><svg fill="none" version="1.1" width="15.435028109846769" height="26.87807685863504" viewBox="0 0 15.435028109846769 26.87807685863504"><g style="mix-blend-mode:passthrough" transform="matrix(0.9999999403953552,0,0,0.9999999403953552,0,0)"><path d="M0.585787,14.8533L12.0208,26.2883C13.2807,27.5482,15.435,26.6559,15.435,24.8741L15.435,2.00401C15.435,0.222199,13.2807,-0.670133,12.0208,0.589795L0.585787,12.0248C-0.195262,12.8059,-0.195262,14.0722,0.585787,14.8533Z" fill="#D8D8D8" fill-opacity="0.800000011920929"/></g></svg></button></label>
                                <label><button class="cc-btn cc-middle" onmousedown="cmdSend(1,0,0);" ontouchstart="cmdSend(1,0,0);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);">STOP</button></label>
                                <label><button class="cc-btn" onmousedown="cmdSend(1,1,-1);" ontouchstart="cmdSend(1,1,-1);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);"><svg fill="none" version="1.1" width="15.435030017195288" height="26.87807685863504" viewBox="0 0 15.435030017195288 26.87807685863504"><g style="mix-blend-mode:passthrough" transform="matrix(0.9999999403953552,0,0,0.9999999403953552,0,0)"><path d="M14.8492,12.0248L3.41422,0.589796C2.15429,-0.670133,-9.53674e-7,0.222199,9.53674e-7,2.00401L9.53674e-7,24.8741C-9.53674e-7,26.6559,2.15429,27.5482,3.41421,26.2883L14.8492,14.8533C15.6303,14.0722,15.6303,12.8059,14.8492,12.0248Z" fill="#D8D8D8" fill-opacity="0.800000011920929"/></g></svg></button></label>
                            </div>
                            <div>
                                <label><button class="cc-btn" onmousedown="cmdSend(1,-0.5,-1);" ontouchstart="cmdSend(1,-0.5,-1);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);"><svg fill="none" version="1.1" width="23" height="23" viewBox="0 0 23 23"><g style="mix-blend-mode:passthrough" transform="matrix(0,-1,1,0,-23,23)"><path d="M0,25L0,41.1716C0,42.9534,2.15428,43.8457,3.41421,42.5858L19.5858,26.41421C20.8457,25.15428,19.9534,23,18.1716,23L2,23C0.895431,23,0,23.895431,0,25Z" fill="#D8D8D8" fill-opacity="0.20000000298023224"/></g></svg></button></label>
                                <label><button class="cc-btn" onmousedown="cmdSend(1,-1,-1);" ontouchstart="cmdSend(1,-1,-1);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);"><svg fill="none" version="1.1" width="26.87807685863504" height="15.435030017195231" viewBox="0 0 26.87807685863504 15.435030017195231"><g style="mix-blend-mode:passthrough" transform="matrix(0.9999999403953552,0,0,0.9999999403953552,0,0)"><path d="M14.8533,14.8492L26.2883,3.41422C27.5482,2.15429,26.6559,-9.53674e-7,24.8741,9.53674e-7L2.00401,9.53674e-7C0.222199,-9.53674e-7,-0.670133,2.15429,0.589795,3.41421L12.0248,14.8492C12.8059,15.6303,14.0722,15.6303,14.8533,14.8492Z" fill="#D8D8D8" fill-opacity="0.800000011920929"/></g></svg></button></label>
                                <label><button class="cc-btn" onmousedown="cmdSend(1,-1,-0.5);" ontouchstart="cmdSend(1,-1,-0.5);" onmouseup="cmdSend(1,0,0);" ontouchend="cmdSend(1,0,0);"><svg fill="none" version="1.1" width="23" height="23" viewBox="0 0 23 23"><g style="mix-blend-mode:passthrough" transform="matrix(-1,0,0,-1,46,46)"><path d="M23,25L23,41.1716C23,42.9534,25.15428,43.8457,26.41421,42.5858L42.5858,26.41421C43.8457,25.15428,42.9534,23,41.1716,23L25,23C23.895431,23,23,23.895431,23,25Z" fill="#D8D8D8" fill-opacity="0.20000000298023224"/></g></svg></button></label>
                            </div>
                        </div>
                    </div>
                    <div class="control-speed">
                        <div>
                            <div id="device-speed-btn">
                                <label><button name="speedbtn" class="small-btn" onclick="cmdSend(2,0,0);">SLOW</button></label>
                                <label><button name="speedbtn" class="small-btn" onclick="cmdSend(2,1,1);">MIDDLE</button></label>
                                <label><button name="speedbtn" class="small-btn" onclick="cmdSend(2,2,2);">FAST</button></label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section>
            ...
            <div class="fb-input-info">
                ...
                <div class="info-box json-cmd-info">
                    ...
                    <div>
                        <p>SPEED_INPUT: <span id="cmd1" class="cmd-value">{"T":1,"L":0.5,"R":0.5}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd1');">INPUT</button>
                    </div>
                    <div>
                        <p>PID_SET: <span id="cmd2" class="cmd-value">{"T":2,"P":170,"I":90}</span></p>
                ...
                <div class="info-box json-cmd-info">
                    <div>
                        <p>PWM_SERVO_CTRL: <span id="cmd4" class="cmd-value">{"T":40,"pos":90,"spd":30}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd4');">INPUT</button>
                    </div>
                    <div>
                        <p>PWM_SERVO_MID: <span id="cmd-4" class="cmd-value">{"T":-4}</span></p>
                ...
                <div class="info-box json-cmd-info">
                    <div>
                        <p>WIFI_SCAN: <span id="cmd60" class="cmd-value">{"T":60}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd60');">INPUT</button>
                    </div>
                    <div>
                        <p>WIFI_TRY_STA: <span id="cmd61" class="cmd-value">{"T":61}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd61');">INPUT</button>
                    </div>
                    <div>
                        <p>WIFI_AP_DEFAULT: <span id="cmd62" class="cmd-value">{"T":62}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd62');">INPUT</button>
                    </div>
                    ...
                    <div>
                        <p>WIFI_OFF: <span id="cmd66" class="cmd-value">{"T":66}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd66');">INPUT</button>
                    </div>
                </div>
                <div class="info-box json-cmd-info">
                    <div>
                    ...
                    <div>
                        <p>ENCODER_INFO: <span id="cmd73" class="cmd-value">{"T":73}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd73');">INPUT</button>
                    </div>
                ...
                <div class="info-box json-cmd-info">
                    <div>
                        <p>IO_IR_CUT: <span id="cmd80" class="cmd-value">{"T":80,"status":1}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd80');">INPUT</button>
                    </div>
                </div>
                <div class="info-box json-cmd-info">
                    <div>
                        <p>SET_SPD_RATE: <span id="cmd901" class="cmd-value">{"T":901,"L":1.0,"R":1.0}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd901');">INPUT</button>
                    </div>
                    <div>
                        <p>GET_SPD_RATE: <span id="cmd902" class="cmd-value">{"T":902}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd902');">INPUT</button>
                    </div>
                    <div>
                        <p>SPD_RATE_SAVE: <span id="cmd903" class="cmd-value">{"T":903}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd903');">INPUT</button>
                    </div>
                </div>
                <div class="info-box json-cmd-info">
                    <div>
                        <p>GET_NVS_SPACE: <span id="cmd904" class="cmd-value">{"T":904}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd904');">INPUT</button>
                    </div>
                    <div>
                        <p>NVS_CLEAR: <span id="cmd905" class="cmd-value">{"T":905}</span></p>
                        <button class="w-btn" onclick="cmdFill('jsonData', 'cmd905');">INPUT</button>
                    </div>
                </div>
            </div>
        </section>
